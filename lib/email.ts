...
const FROM = process.env.EMAIL_FROM || 'BizClaimFlow - Simplified Business Accident Claims <noreply@example.com>';
const APP_NAME = 'BizClaimFlow - Simplified Business Accident Claims';

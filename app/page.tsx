  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">BizClaimFlow - Simplified Business Accident Claims</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Streamlines the complex and frustrating process of managing insurance claims and compensation for businesses after accidents or damages, reducing administrative burden, improving claim accuracy, and accelerating payout times for small to medium enterprises.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust BizClaimFlow - Simplified Business Accident Claims.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} BizClaimFlow - Simplified Business Accident Claims. All rights reserved.</p>

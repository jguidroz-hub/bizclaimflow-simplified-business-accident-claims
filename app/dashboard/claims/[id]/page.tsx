...
export default function Claims/[id]Page() {
  const [items, setItems] = useState<Claims/[id]Item[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-6">Detailed view of specific claim</p>
